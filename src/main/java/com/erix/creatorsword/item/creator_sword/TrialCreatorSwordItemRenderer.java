...
@OnlyIn(Dist.CLIENT)
public class TrialCreatorSwordItemRenderer extends BaseCreatorSwordItemRenderer {

    private static final PartialModel SWORD = PartialModel.of(
            ResourceLocation.fromNamespaceAndPath("creatorsword", "item/creator_sword/trial_sword")
    );
    private static final PartialModel ROTATING_GEAR = PartialModel.of(
            ResourceLocation.fromNamespaceAndPath("creatorsword", "item/creator_sword/trial_gear")
    );
