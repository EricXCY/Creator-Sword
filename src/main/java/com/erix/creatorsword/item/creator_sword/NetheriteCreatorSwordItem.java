...
public class NetheriteCreatorSwordItem extends WrenchItem {

    public NetheriteCreatorSwordItem(Properties properties) {
        super(new Properties().fireResistant().durability(2031).attributes(SwordItem.createAttributes(Tiers.NETHERITE, 4.2f, -2.3f)));
    }
