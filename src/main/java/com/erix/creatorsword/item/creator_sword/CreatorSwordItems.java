...
public class CreatorSwordItems {
    ...
    public static final DeferredItem<WrenchItem> CREATOR_SWORD = ITEMS.registerItem("creator_sword",
            CreatorSwordItem::new);
    public static final DeferredItem<WrenchItem> NETHERITE_CREATOR_SWORD = ITEMS.registerItem("netherite_creator_sword",
