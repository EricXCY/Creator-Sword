...
public class CreatorSwordCriteriaTriggers {
    ...
    public static final DeferredHolder<CriterionTrigger<?>, AdvancementSpeedTrigger> ADVANCEMENT_SPEED =
            TRIGGERS.register("advancement_speed", AdvancementSpeedTrigger::new);
